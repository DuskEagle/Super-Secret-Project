...
(function() {
  ...
  function DragNodes(s, renderer) {
    ...
    var _self = this,
      ...
      _drag = false,
      _mouseEnabled = renderer.settings("mouseEnabled"),
      _enableHovering = renderer.settings("enableHovering");
    ...
    function calculateOffset(element) {
      ...
      return {
        ...
        right: element.getBoundingClientRect().right + getCssProperty('padding-right'),
        bottom: element.getBoundingClientRect().bottom + getCssProperty('padding-bottom')
      };
    };
    ...
    function nodeMouseDown(event) {
      ...
      if (_node && size > 1) {
        ...
        _mouseEnabled = _renderer.settings("mouseEnabled");
        _enableHovering = _renderer.settings("enableHovering");
    ...
    function nodeMouseUp(event) {
      ...
      // Activate drag graph (if it was active before the drag started).
      _renderer.settings({mouseEnabled: _mouseEnabled, enableHovering: _enableHovering});
      _s.refresh();
